    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavBar(
        ...
        onTap: (index) {
          ...
          switch (index) {
            case 0:
              Get.offAllNamed(Routes.KARYAWANHOME); // Replace with your actual home route
              break;
            case 1:
              Get.offAllNamed(
                  Routes.KARYAWAN_DASHBOARD); // Replace with your actual dashboard route
              break;
            case 2:
              Get.offAllNamed(
                  Routes.KARYAWANPROFILE); // Replace with your actual profile route
              break;
            default:
          }
        },
